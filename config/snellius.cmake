...
if(USECUDA)
    ...
    if(USEINTEL)
        ...
        set(USER_CXX_FLAGS_RELEASE "-O3 -xHOST")
        add_definitions(-DRESTRICTKEYWORD=restrict)
        set(USER_FC_FLAGS "-m64 -g -traceback -heap-arrays -assume realloc_lhs -extend-source 132")
        set(USER_FC_FLAGS_RELEASE "-O3 -xHOST")
    else()
