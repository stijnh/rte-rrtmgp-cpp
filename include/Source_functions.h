...
class Source_func_lw_gpu : public Optical_props_gpu
{
    public:
        ...
        Array_gpu<SOURCE_TYPE,3>& get_lay_source()     { return lay_source;     }
        Array_gpu<SOURCE_TYPE,3>& get_lev_source()     { return lev_source;     }
        ...
        const Array_gpu<SOURCE_TYPE,3>& get_lay_source()     const { return lay_source;     }
        const Array_gpu<SOURCE_TYPE,3>& get_lev_source()     const { return lev_source;     }
