...
class Source_func_lw_gpu : public Optical_props_gpu
{
    public:
        ...
        Array_gpu<FloatSurface,2>& get_sfc_source()     { return sfc_source;     }
        Array_gpu<Float,2>& get_sfc_source_jac() { return sfc_source_jac; }
        Array_gpu<FloatSource,3>& get_lay_source()     { return lay_source;     }
        Array_gpu<FloatSource,3>& get_lev_source()     { return lev_source;     }

        const Array_gpu<FloatSurface,2>& get_sfc_source()     const { return sfc_source;     }
        const Array_gpu<Float,2>& get_sfc_source_jac() const { return sfc_source_jac; }
        const Array_gpu<FloatSource,3>& get_lay_source()     const { return lay_source;     }
        const Array_gpu<FloatSource,3>& get_lev_source()     const { return lev_source;     }
