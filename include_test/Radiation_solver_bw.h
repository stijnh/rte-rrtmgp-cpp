...
class Radiation_solver_longwave
{
    public:
        ...
        void solve_gpu(
                ...
                const bool switch_output_bnd_fluxes,
                const Gas_concs_gpu& gas_concs,
                const Array_gpu<PRESSURE_TYPE,2>& p_lay, const Array_gpu<Float,2>& p_lev,
                const Array_gpu<TEMPERATURE_TYPE,2>& t_lay, const Array_gpu<TEMPERATURE_TYPE,2>& t_lev,
                Array_gpu<DRY_COL_TYPE,2>& col_dry,
                const Array_gpu<SURFACE_TYPE,1>& t_sfc, const Array_gpu<SURFACE_TYPE,2>& emis_sfc,
