...
void Gas_optics_rrtmgp<TF>::gas_optics(
        ...
        gas_optics_work_arrays<TF>* work_arrays) const
{
...
void Gas_optics_rrtmgp<TF>::compute_gas_taus(
        ...
        Array<TF,6>& fmajor,
        const Array<TF,2>& col_dry,
        gas_taus_work_arrays<TF>* work_arrays) const
{
    auto wrk = work_arrays;
    if(work_arrays == nullptr)
    {
...
void Gas_optics_rrtmgp<TF>::source(
        ...
        Source_func_lw<TF>& sources,
        const Array<TF,2>& tlev,
        gas_source_work_arrays<TF>* work_arrays) const
{
...
template class gas_taus_work_arrays<float>;
template class gas_source_work_arrays<float>;
template class gas_optics_work_arrays<float>;
#else
template class Gas_optics_rrtmgp<double>;
template class gas_taus_work_arrays<double>;
template class gas_source_work_arrays<double>;
template class gas_optics_work_arrays<double>;
#endif
