        ...
        rte_lw_work_arrays_gpu<TF>* workptr)
{
    ...
    rte_kernel_launcher_cuda::lw_solver_noscat_gaussquad(
            ...
            work->sfc_src_jac, work->gpt_flux_up_jac, work->tau_loc, work->radn_up,
            work->radn_up_jac, work->radn_dn, work->trans, work->source_dn,
            work->source_up, work->source_sfc, work->source_sfc_jac, work->sfc_albedo
        );
...
template class rte_lw_work_arrays_gpu<float>;
#else
template class Rte_lw_gpu<double>;
template class rte_lw_work_arrays_gpu<double>;
#endif
