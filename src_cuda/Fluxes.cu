...
void Fluxes_broadband_gpu::reduce(
    const Array_gpu<FloatFlux,3>& gpt_flux_up, const Array_gpu<FloatFlux,3>& gpt_flux_dn,
...
void Fluxes_broadband_gpu::reduce(
    const Array_gpu<FloatFlux,3>& gpt_flux_up, const Array_gpu<FloatFlux,3>& gpt_flux_dn, const Array_gpu<FloatFlux,3>& gpt_flux_dn_dir,
    const std::unique_ptr<Optical_props_arry_gpu>& spectral_disc,
    const Bool top_at_1)
{
    const int ncol = gpt_flux_up.dim(1);
...
void Fluxes_byband_gpu::reduce(
    const Array_gpu<FloatFlux,3>& gpt_flux_up,
    const Array_gpu<FloatFlux,3>& gpt_flux_dn,
    const std::unique_ptr<Optical_props_arry_gpu>& spectral_disc,
    const Bool top_at_1)
{
    const int ncol = gpt_flux_up.dim(1);
...
void Fluxes_byband_gpu::reduce(
    const Array_gpu<FloatFlux,3>& gpt_flux_up,
    const Array_gpu<FloatFlux,3>& gpt_flux_dn,
    const Array_gpu<FloatFlux,3>& gpt_flux_dn_dir,
    const std::unique_ptr<Optical_props_arry_gpu>& spectral_disc,
    const Bool top_at_1)
{
    const int ncol = gpt_flux_up.dim(1);
