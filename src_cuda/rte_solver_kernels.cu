...
namespace rte_kernel_launcher_cuda
{
    ...
    void lw_solver_noscat_gaussquad(const int ncol, const int nlay, const int ngpt, const BOOL_TYPE top_at_1, const int nmus,
                                    ...
                                    const Array_gpu<TF,2>& sfc_src, 
                                    Array_gpu<TF,3>& flux_up, 
                                    Array_gpu<TF,3>& flux_dn,
                                    const Array_gpu<TF,2>& sfc_src_jac, 
                                    Array_gpu<TF,3>& flux_up_jac,
                                    ...
                                    Array_gpu<TF,2>& sfc_albedo)
    {
        ...
        lw_solver_noscat_gaussquad_kernel<<<grid_gpu2d, block_gpu2d>>>(
                ...
                lev_source_inc.ptr(), lev_source_dec.ptr(), sfc_emis.ptr(), sfc_src.ptr(), radn_up.ptr(),
                radn_dn.ptr(), sfc_src_jac.ptr(), radn_up_jac.ptr(), tau_loc.ptr(), trans.ptr(), source_dn.ptr(), 
                source_up.ptr(), source_sfc.ptr(), sfc_albedo.ptr(), source_sfc_jac.ptr(), flux_up.ptr(), 
                flux_dn.ptr(), flux_up_jac.ptr());
    }
    ...
    void sw_solver_2stream(const int ncol, const int nlay, const int ngpt, const BOOL_TYPE top_at_1,
                           ...
                           Array_gpu<TF,2>& source_sfc, Array_gpu<TF,3>& albedo, Array_gpu<TF,3>& src, 
...
/*        const int opt_size = tau.size() * sizeof(TF);
        ...
        sw_2stream_kernel<<<grid_gpu3d, block_gpu3d>>>(
                ncol, nlay, ngpt, tmin, tau.ptr(), ssa.ptr(), g.ptr(), mu0.ptr(), r_dif.ptr(), t_dif.ptr(), r_dir.ptr(), 
                t_dir.ptr(), t_noscat.ptr());
        ...
        sw_source_adding_kernel<<<grid_gpu2d, block_gpu2d>>>(
                ncol, nlay, ngpt, top_at_1, sfc_alb_dir.ptr(), sfc_alb_dif.ptr(), r_dif.ptr(), t_dif.ptr(), 
                r_dir.ptr(), t_dir.ptr(), t_noscat.ptr(), flux_up.ptr(), flux_dn.ptr(), flux_dir.ptr(), source_up.ptr(), 
                source_dn.ptr(), source_sfc.ptr(), albedo.ptr(), src.ptr(), denom.ptr());
...
template void rte_kernel_launcher_cuda::sw_solver_2stream<float>(
            ...
            Array_gpu<float,3>& r_dif, Array_gpu<float,3>& t_dif, Array_gpu<float,3>& r_dir, Array_gpu<float,3>& t_dir,
            Array_gpu<float,3>& t_noscat, Array_gpu<float,3>& source_up, Array_gpu<float,3>& source_dn,
            Array_gpu<float,2>& source_sfc, Array_gpu<float,3>& albedo, 
            Array_gpu<float,3>& src, Array_gpu<float,3>& denom);
...
template void rte_kernel_launcher_cuda::lw_solver_noscat_gaussquad<float>(
            ...
            Array_gpu<float,3>& radn_up, Array_gpu<float,3>& radn_up_jac, Array_gpu<float,3>& radn_dn,
            Array_gpu<float,3>& trans, Array_gpu<float,3>& source_dn, Array_gpu<float,3>& source_up,
            Array_gpu<float,2>& source_sfc, Array_gpu<float,2>& source_sfc_jac, Array_gpu<float,2>& sfc_albedo);
...
template void rte_kernel_launcher_cuda::sw_solver_2stream<double>(
            ...
            Array_gpu<double,3>& r_dif, Array_gpu<double,3>& t_dif, Array_gpu<double,3>& r_dir, Array_gpu<double,3>& t_dir,
            Array_gpu<double,3>& t_noscat, Array_gpu<double,3>& source_up, Array_gpu<double,3>& source_dn,
            Array_gpu<double,2>& source_sfc, Array_gpu<double,3>& albedo, 
            Array_gpu<double,3>& src, Array_gpu<double,3>& denom);
...
template void rte_kernel_launcher_cuda::lw_solver_noscat_gaussquad<double>(
            ...
            Array_gpu<double,3>& radn_up, Array_gpu<double,3>& radn_up_jac, Array_gpu<double,3>& radn_dn,
            Array_gpu<double,3>& trans, Array_gpu<double,3>& source_dn, Array_gpu<double,3>& source_up,
            Array_gpu<double,2>& source_sfc, Array_gpu<double,2>& source_sfc_jac, Array_gpu<double,2>& sfc_albedo);
#endif
