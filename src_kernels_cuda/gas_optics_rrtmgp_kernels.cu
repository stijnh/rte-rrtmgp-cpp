...
void Planck_source_kernel(
        ...
        const TempType* __restrict__ tlay, const TempType* __restrict__ tlev,
        const TempType* __restrict__ tsfc,
        const int sfc_lay,
...
void interpolation_kernel(
        ...
        const PressureType* __restrict__ play,
        const TempType* __restrict__ tlay,
